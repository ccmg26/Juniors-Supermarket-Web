...
const footerLinks = {
  ...
  Locations: [
    ...
    { href: "/locations", label: "Rio Grande Valley" },
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <div className="flex items-center gap-3 mt-4">
              <a
                ...
                className="w-8 h-8 rounded-full bg-bg/10 hover:bg-brand transition-colors flex items-center justify-center"
              >
                <svg className="w-4 h-4 text-bg/70 hover:text-brand-fg" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
