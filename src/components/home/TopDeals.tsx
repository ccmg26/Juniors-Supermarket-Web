    ...
    <section className="py-10 bg-card">
      <div className="container-max px-4">
        ...
        {specials.length > 0 ? (
          ...
          <div className="rounded-2xl border border-border bg-muted px-6 py-10 text-center mb-6">
            <p className="text-3xl mb-3" aria-hidden="true">🗞</p>
            <p className="font-bold text-fg">New deals are posted every Wednesday</p>
            <p className="text-sm text-muted-fg mt-1">
              Check the official weekly ad for the latest verified prices.
            </p>
          </div>
        )}
        ...
        <div className="rounded-xl bg-brand/10 border border-brand/20 px-5 py-4 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div>
            <p className="font-semibold text-fg text-sm">
              {specials.length > 0 ? `${specials.length} verified deals this week` : 'The ad resets every Wednesday'}
            </p>
