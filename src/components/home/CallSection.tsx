  ...
  return (
    <section className="section-pad bg-brand-warm">
      <div className="container-max text-center max-w-xl">
        <div className="w-20 h-20 bg-brand-red rounded-full flex items-center justify-center mx-auto mb-6 shadow-lg">
        ...
        <p className="text-brand-gray text-sm mt-4">Open Daily · 7:00 AM – 10:00 PM</p>
      </div>
    </section>
  );
}
