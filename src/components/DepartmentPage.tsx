      ...
      <div className="bg-hero-pattern py-16 px-4">
        <div className="container-max">
          ...
          <div className="flex items-center gap-4 mt-3">
            ...
            <div>
              <h1 className="text-4xl sm:text-5xl font-black text-white leading-tight">{title}</h1>
              <p className="text-brand-red font-semibold text-sm uppercase tracking-wide mt-1">
          ...
          <div className="grid lg:grid-cols-3 gap-10">
            <div className="lg:col-span-2 space-y-8">
              ...
              <div className="card p-6 sm:p-8">
                <p className="text-brand-gray text-base leading-relaxed text-lg">{description}</p>
                {highlights.length > 0 && (
                  <ul className="mt-6 space-y-2">
                    {highlights.map((h) => (
                      <li key={h} className="flex items-start gap-2 text-brand-black text-sm">
              ...
              {gallery.length > 0 && (
                <div>
                  <h2 className="font-black text-brand-black text-2xl mb-4">Gallery</h2>
            ...
            <div className="space-y-4">
              <div className="card p-6 text-center">
                <h3 className="font-black text-brand-black text-lg mb-2">Visit a Store</h3>
              ...
              <div className="card p-6 text-center">
                <h3 className="font-black text-brand-black text-lg mb-2">This Week&apos;s Deals</h3>
                <p className="text-brand-gray text-sm mb-4">
