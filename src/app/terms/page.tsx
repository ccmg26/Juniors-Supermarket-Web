        ...
        <div className="container-max max-w-3xl">
          <div className="card p-8 sm:p-12">
            <div className="space-y-8 text-brand-gray leading-relaxed">
              <div>
                <h2 className="text-xl font-black text-brand-black mb-3">1. Acceptance of Terms</h2>
                <p>
              ...
              <div>
                <h2 className="text-xl font-black text-brand-black mb-3">2. Use of Website</h2>
                <p>
              ...
              <div>
                <h2 className="text-xl font-black text-brand-black mb-3">3. Pricing & Product Availability</h2>
                <p>
                  All prices, deals, and specials shown on this website are subject to change without
                  notice. <strong className="text-brand-black">While Supplies Last.</strong> Prices and availability
              ...
              <div>
                <h2 className="text-xl font-black text-brand-black mb-3">4. Weekly Ad</h2>
                <p>
              ...
              <div>
                <h2 className="text-xl font-black text-brand-black mb-3">5. Intellectual Property</h2>
                <p>
              ...
              <div>
                <h2 className="text-xl font-black text-brand-black mb-3">6. Disclaimer of Warranties</h2>
                <p>
              ...
              <div>
                <h2 className="text-xl font-black text-brand-black mb-3">7. Limitation of Liability</h2>
                <p>
              ...
              <div>
                <h2 className="text-xl font-black text-brand-black mb-3">8. Governing Law</h2>
                <p>
              ...
              <div>
                <h2 className="text-xl font-black text-brand-black mb-3">9. Contact</h2>
                <p>
